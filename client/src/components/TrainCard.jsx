  ...
  return (
    <div className='ml-80 mt-5 mr-2'>
      ...
      <div className="mt-4 m-1 ml-4 ">
        <button onClick={()=>{setSelectedDate(datee)}}  className= {selectedDate.getDate() == dateofthemonth ? " border-2 border-indigo-600  bg-gray-300  mr-3 text-left p-2 rounded  pr-10" : "border-2  bg-gray-300  mr-3 text-left p-2 rounded  pr-10"}>  <span className='text-md font-bold'> {dayOfWeek}, {dateofthemonth} {monthsoftheyear[datee.getMonth()]}</span> <br></br> <span className='text-lg font-bold text-green-500'>AVAILABLE {prop.totalCapacity - one}</span> </button>
        <button onClick={()=>{setSelectedDate(date2)}} className= {selectedDate.getDate() == date2.getDate() ? " border-2 border-indigo-600  bg-gray-300  mr-3 text-left p-2 rounded  pr-10" : "border-2  bg-gray-300  mr-3 text-left p-2 rounded  pr-10"}>  <span className='text-md font-bold'> {daysOfWeek[date2.getDay()]}, {date2.getDate()} {monthsoftheyear[date2.getMonth()]}</span> <br></br> <span className='text-lg font-bold text-green-500'>AVAILABLE {prop.totalCapacity - two}</span> </button>
        <button onClick={()=>{setSelectedDate(date3)}} className= {selectedDate.getDate() == date3.getDate() ? " border-2 border-indigo-600  bg-gray-300  mr-3 text-left p-2 rounded  pr-10" : "border-2  bg-gray-300  mr-3 text-left p-2 rounded  pr-10"}>  <span className='text-md font-bold'> {daysOfWeek[date3.getDay()]}, {date3.getDate()} {monthsoftheyear[date3.getMonth()]}</span> <br></br> <span className='text-lg font-bold text-green-500'>AVAILABLE {prop.totalCapacity - three}</span> </button>
        <button onClick={()=>{setSelectedDate(date4)}} className= {selectedDate.getDate() == date4.getDate() ? " border-2 border-indigo-600  bg-gray-300  mr-3 text-left p-2 rounded  pr-10" : "border-2  bg-gray-300  mr-3 text-left p-2 rounded  pr-10"}>  <span className='text-md font-bold'> {daysOfWeek[date4.getDay()]}, {date4.getDate()} {monthsoftheyear[date4.getMonth()]}</span> <br></br> <span className='text-lg font-bold text-green-500'>AVAILABLE {prop.totalCapacity - four}</span> </button>
        <button onClick={()=>{setSelectedDate(date5)}} className= {selectedDate.getDate() == date5.getDate() ? " border-2 border-indigo-600  bg-gray-300  mr-3 text-left p-2 rounded  pr-10" : "border-2  bg-gray-300  mr-3 text-left p-2 rounded  pr-10"}>  <span className='text-md font-bold'> {daysOfWeek[date5.getDay()]}, {date5.getDate()} {monthsoftheyear[date5.getMonth()]}</span> <br></br> <span className='text-lg font-bold text-green-500'>AVAILABLE {prop.totalCapacity - five}</span> </button>
        <button onClick={()=>{setSelectedDate(date6)}} className= {selectedDate.getDate() == date6.getDate() ? " border-2 border-indigo-600  bg-gray-300  mr-3 text-left p-2 rounded  pr-10" : "border-2  bg-gray-300  mr-3 text-left p-2 rounded  pr-10"}>  <span className='text-md font-bold'> {daysOfWeek[date6.getDay()]}, {date6.getDate()} {monthsoftheyear[date6.getMonth()]}</span> <br></br> <span className='text-lg font-bold text-green-500'>AVAILABLE {prop.totalCapacity - six}</span> </button>
